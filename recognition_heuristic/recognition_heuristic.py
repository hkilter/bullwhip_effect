...
def frequency_train(c1):
    c1.train('LA , CA ', '90011')
    c1.train('Los Angelges, CA', '90011')
    c1.train('BEVERLY HILLS, CA', '90210')
    c1.train('RANCHO PALOS VERDES, CA', '90275')
    c1.train('INGLEWOOD, CA', '90301')
    c1.train('BELL, CA', '90201')
...
def impact_train(c1):
    c1.impactodds('90210', 21495)
    c1.impactodds('90011', 101214)
    c1.impactodds('90275', 41261)
    c1.impactodds('90301', 37507)
    c1.impactodds('90201', 105275)
