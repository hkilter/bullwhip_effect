...
for org in databases:
    try:
        ...
        # word pattern and/or tag mining patterns
        ...
        for i in range(len(comp_ids)):
            try:
                if(sent_class[i] == 'COMP'):
                    ...
                    db.save(doc)
                    print 'sentence type updated ' + str(DB)
                    print doc
            except:
        ...
        for i in range(len(loc_ids)):
            try:
                if(loc_sent[i] == 'LOCATION'):
                    ...
                    db.save(doc)
                    print 'location updatated ' + str(DB)
            except:
