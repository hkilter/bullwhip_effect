...
##noun_phrase = ChunkRule('(<DT>|<JJ>)<NN.*>', 'chunk noun phrases')
##comparison_phrase =ChunkRule('(<DT>|<JJ>)(<JJR>|<JJS>|<RBR>|<RBS>)', 'chunk comparative phrases')
##verb_phrase = ChinkRule('<VB.*>', 'chink verbs')
